...
public class doc_forgot {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					doc_forgot window = new doc_forgot();
	...
	private void initialize() {
		...
		frmForgotPassword.setBounds(100, 100, 654, 618);
		...
		lblNewLabel.setBounds(161, 79, 342, 45);
		...
		submit.setBounds(348, 419, 172, 33);
